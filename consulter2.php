...
<body>
<div style="margin-top: -90px!important;"><?php   require_once'header2.php';  ?></div>
...
<center>
 ...
 <?php
   ...
   <?php
              ...
              ?> <b><center>
              <h2 style="text-decoration: underline; text-align: center;"><?php  echo $cj['mailto'] ?></h2></center><p>CONCTACT:  <?php echo $cj['tel'];?></p></b><?php } ?>
<div class="container"><nav style="text-align: center; color: blue; font-size: 19px;font-family: roboto;">
  ...
  <img src="<?php echo $c['imgf'];?>" style="width: 80%; float: center;margin-right: -9px; height: 390px;" alt=""data-tourne> <br>    </br>
