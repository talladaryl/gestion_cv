...
<br><br>
 ...
 <?php
              ...
              $q =  "SELECT `idim`, `idua`, `chemin`, `user` FROM `suplement` Where idua='".$_GET['id']."'";
              $r = $db -> query($q) ;
              while ($c = $r -> fetch())
              {
     ...
     <img src="<?php echo $c['chemin'];?>" style="width: 40%; float: left;margin-left: 9px; height: 290px;" alt="" data-tourne>
